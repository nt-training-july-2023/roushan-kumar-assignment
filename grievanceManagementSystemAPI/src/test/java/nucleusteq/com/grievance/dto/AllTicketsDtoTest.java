...
public class AllTicketsDtoTest {
  private AllTicketsDto ticketDto;

  @BeforeEach
  public void setUp() {
      // Create a new AllTicketsDto instance before each test
      ticketDto = new AllTicketsDto(1, "Test Ticket", "Test Description", new Department(), new TicketType(), new TicketStatus(),1);
  }
